...
const seed = async () => {
  ...
  const admin = db.prepare(`INSERT INTO users (name, email, password, role) VALUES (?, ?, ?, ?)`).run('Shukla', 'shukla@taskmanager.io', hashedAdmin, 'admin');
  ...
  console.log('  Admin: shukla@taskmanager.io / Admin@123');
